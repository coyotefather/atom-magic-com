...
- [ ] **Session persistence tests** - `sessionPersistence.ts`: getSessionRoster, getSessionById, saveSessionById (roster summary propagation including campaignId), deleteSessionById
- [ ] **Character persistence tests** - `characterPersistence.ts`: getRoster, saveCharacterById (shield calc + summary), deleteCharacterById, migration from single-character storage

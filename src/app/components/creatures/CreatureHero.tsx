				...
				<div className="max-w-4xl mx-auto text-center">
					...
					<div className="flex justify-center mb-6">
						<div className="w-16 h-16 flex items-center justify-center border-2 border-bronze">
							<Icon path={mdiDiceMultiple} size={1.75} className="text-bronze" />
						</div>
					</div>
					...
					<p className="text-lg text-stone-light max-w-2xl mx-auto leading-relaxed">
						A tool for Dominus Ludi to quickly generate and roll creatures for
						encounters. Filter by environment, challenge level, or type, then
						roll to select a random creature.
					</p>
